...
the float differences. In such cases where the PS2's unique floating-point behavior
is required, a file processor that runs on the PS2 is a necessary tool.


This tool is an adaptation of the relevant methods from the [PDTools](https://github.com/Nenkai/PDTools) repository by Nenkai. Main credit goes to Nenkai and the contributor(s) of the PDTools project.
